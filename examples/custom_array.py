...
mesh2 = ps.createbox(20, 30, 6, sound_a, s)
def compute_array(mesh, src_coord, lis_coord, micarray,num):
    ...
    np.save('/root/data/gsound_rir2/rir_' + str(num) + '.npy',res)
    return res
...
def main(num):
    ...
    mic_centerx = random.randint(5,15)
    mic_centery = random.randint(5,15)
    distance1 = round(random.uniform(1.00,1.30),2)
    distance2 = round(random.uniform(1.00,1.30),2)
